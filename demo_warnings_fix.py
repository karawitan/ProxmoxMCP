...
def test_before_fix():
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        warnings.warn("This is a DeprecationWarning that should be visible", DeprecationWarning)
...
def test_after_fix():
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        try:
            ...
            warnings.warn("This SSL warning should be suppressed", InsecureRequestWarning)
        except ImportError:
...
def main():
    ...
    print("SUMMARY:")
    print("✓ The fix restores visibility of RuntimeWarnings and other important warnings")
