...
class TestInputValidator:
    ...
    def test_validate_node_name_valid(self):
        ...
        valid_names = ["pve1", "proxmox-node2", "node_3", "cluster-1", "test-123"]
    ...
    def test_validate_vmid_valid(self):
        """Test valid VM IDs."""
        valid_vmids = ["100", "999", "12345", 100, 999999]  # Integer input  # Max range
    ...
    def test_sanitize_log_data(self):
        ...
        sensitive_data = {
            ...
            "port": 8006,
            "nested": {"secret": "nested-secret", "public": "public-info"},
        }
    ...
    def test_validate_storage_name_valid(self):
        ...
        valid_names = ["local", "ceph-storage", "nfs_backup", "storage.001", "test-123"]
